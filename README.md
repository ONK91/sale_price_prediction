...
Демонстрационное приложение рассчета цены интересующего объекта недвижимости создано с помощью фреймворка `Streamlit`. Развертывание приложения осуществлено в `Heroku` — платформу, позволяющую запускать приложения в облаке и доступно по ссылке: https://stormy-spire-21020.herokuapp.com
